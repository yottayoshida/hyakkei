...
| `line-too-many-series` | line chart with > 4 series | *(rule held for v0.2 — v0.1's schema is single-series-only, see caveat below; the rule cannot fire against anything v0.1 can express)* |
