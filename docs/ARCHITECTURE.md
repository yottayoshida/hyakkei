...
| Charts | Apache ECharts 6.1.0 (currently `^6.1.0`; **to be exact-pinned in PR-B**, see ADR-0004), **SVG renderer** | Covers all guidebook chart types incl. maps later; SVG chosen over canvas for golden-test determinism and a screen-reader-readable DOM (M0 spike, ADR-0004 amended 2026-07-10); strong CJK text handling (with an explicit `axisLabel.interval` override — see spike); Apache-2.0 |
